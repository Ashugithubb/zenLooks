...
export class AddedManyTables1760370930696 implements MigrationInterface {
    name = 'AddedManyTables1760370930696'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bookings" ("bookingId" SERIAL NOT NULL, "date" date NOT NULL, "slot" TIME NOT NULL, "phoneNo" character varying NOT NULL, "bookedAt" TIMESTAMP NOT NULL DEFAULT now(), "paymentStatus" "public"."bookings_paymentstatus_enum" NOT NULL DEFAULT 'Pending', "serviceId" integer, "userId" integer, CONSTRAINT "PK_35a5c2c23622676b102ccc3b113" PRIMARY KEY ("bookingId"))`);
