...
// };
// export default function Services({ accessToken }: ServicesProps) {
...
//         setTimeout(() => {
//             if (accessToken) {
//                  console.log("accessToken in set Time out",accessToken);
...
import Services from "./service" // your current client component

export default async function ServicesPage() {
  const cookieStore = cookies();
  const accessToken = (await cookieStore).get("access_token")?.value || null;

  return <Services accessToken={accessToken} />;
}
